...
-- Multiempresa, Multiroles, Multiusuario
-- ============================================
...
CREATE TABLE reports (
  id BIGSERIAL PRIMARY KEY,
  company_id BIGINT NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
  type VARCHAR(50), -- monthly, annual, category, cash_flow
  period_start DATE,
  period_end DATE,
  data JSONB,
...
-- Políticas para miembros de empresa
...
-- Función para verificar límite de facturas
...
BEGIN
  ...
  -- Si es NULL (ilimitado), retornar TRUE
...
-- Función para incrementar contador de facturas
